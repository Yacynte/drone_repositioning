...
public:
    ...
    bool respositionFunc(cv::Point3f rotation_rate, cv::Point3f translation_rate, float rot_error, float trans_error, cv::Point3f translation, std::string& data_to_send);
